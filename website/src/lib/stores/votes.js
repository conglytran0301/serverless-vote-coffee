...
const petConfigs = {
	Espresso: { img_url: 'images/espresso.png', order: 1 },
	Cappuccino: { img_url: 'images/cappuccino.png', order: 2 },
	Americano: { img_url: 'images/americano.png', order: 3 }
};

const defaultPets = [
	{ id: 'Espresso', votes: 0, ...petConfigs['Espresso'] },
	{ id: 'Cappuccino', votes: 0, ...petConfigs['Cappuccino'] },
	{ id: 'Americano', votes: 0, ...petConfigs['Americano'] }
]
